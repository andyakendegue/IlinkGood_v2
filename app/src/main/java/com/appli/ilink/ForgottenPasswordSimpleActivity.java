                ...
                StringRequest stringRequest = new StringRequest(Request.Method.POST, REGISTER_URL,
                        new Response.Listener<String>() {
                            ...
                            public void onResponse(String response) {
                                if(response.equalsIgnoreCase(Config.LOGIN_SUCCESS)) {
                                    Toast.makeText(ForgottenPasswordSimpleActivity.this, "Changement de mot de passe reussi! Reconnectez-vous avec le numero de telephone et le nouveau mot de passe.", Toast.LENGTH_LONG).show();
                                    Intent i = new Intent(ForgottenPasswordSimpleActivity.this, LoginActivity.class);
                                    startActivity(i);

                                    finish();
                                }else {
                                    Toast.makeText(ForgottenPasswordSimpleActivity.this, response, Toast.LENGTH_LONG).show();
                        ...
                        new Response.ErrorListener() {
                            ...
                            public void onErrorResponse(VolleyError error) {
                                Toast.makeText(ForgottenPasswordSimpleActivity.this, "Connexion au serveur impossible", Toast.LENGTH_LONG).show();
                            }
                        }) {
                    @Override
                    protected Map<String, String> getParams() {
                        ...
                        params.put(KEY_TAG, "chgpass_simple");
                        return params;
                    }
